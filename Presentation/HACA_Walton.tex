...
\begin{frame}{Access the National Table}
    \begin{center}
        ...
        \vspace{0.5cm}
        \href{https://github.com/The-Strategy-Unit/nhs-waiting-list-explorer}{github.com/The-Strategy-Unit/nhs-waiting-list-explorer}
...
\begin{frame}{Abiding principles}
  ...
  Try to keep things simple, accessible, practical.\\

  Holistic: Try as many avenues as possible in the hope something sticks!\\

  Money is tight but people are generous with their time.\\
\vspace{2cm}
